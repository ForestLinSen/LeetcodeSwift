...
class Solution {
    func partition(_ s: String) -> [[String]] {
        ...
        func backtracking(_ curr: inout [String], _ characters: [Character]){
            ...
            for i in 0..<characters.count{
                if isPalindrome(characters, 0, i){
                    curr.append(String(characters[0...i]))
                    backtracking(&curr, Array(characters[(i+1)...]))
                    curr.removeLast()
                }
            }
        }
